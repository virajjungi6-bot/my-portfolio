...
// Base query - only Full Paid
$sql = "SELECT * FROM selldata WHERE payment_status = 'Full Paid'";
    ...
    <?php if ($result && mysqli_num_rows($result) > 0): ?>
        <?php while($row = mysqli_fetch_assoc($result)): ?>
            <tr>
                ...
                <td><?= $row['sale_date'] ?></td>
                <td>
                    <a class="action-btn" style="background-color: #27ae60;" href="22genrate_bill.php?sale_id=<?= $row['sale_id'] ?>">Generate Bill</a>
                </td>
            </tr>
        <?php endwhile; ?>
    <?php else: ?>
